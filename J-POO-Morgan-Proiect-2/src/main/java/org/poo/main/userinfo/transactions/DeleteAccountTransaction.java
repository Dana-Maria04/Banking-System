...
/**
 * Represents a transaction for deleting an account.
 */
public class DeleteAccountTransaction extends Transaction {

    /**
     * Constructs a DeleteAccountTransaction instance with the specified parameters.
     *
     ...
     * @param iban        The IBAN associated with the account being deleted.
     */
